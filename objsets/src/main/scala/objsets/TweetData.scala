...
object TweetData {
  val gizmodo =
    """[
{ "user": "gizmodo", "text": "android Paperwhite Review: Forget Everything Else, This Is the E-Reader You Want http://t.co/737W6aNC", "retweets": 51.0 },
...
{ "user": "gizmodo", "text": "Yep, the TSA is definitely stealing iPad: http://t.co/THYd8MKe", "retweets": 79.0 },
...
{ "user": "gizmodo", "text": "iphone Young unveils his new Pono music player: http://t.co/EEMznUio", "retweets": 27.0 },
